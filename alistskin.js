...
flower_header_append_code += `<h3>云尘星球-收集世间万物</h3>`; 
flower_header_append_code += `<div class="flower_header_self_headimg">`; 
flower_header_append_code += `<img src="https://pan.xhto.cn/d/network/avatar/avatar_002.jpg?sign=FF35Uivo58afgGE0ZfeCgZPWLuZSgCq4zrBbLY0VJdE=:0">`; 
...
flower_footer_append_code += `<a class="flower_footer_codea" href="http://beian.miit.gov.cn/"  target="_blank" >粤ICP备2020118789号</a>`; 
